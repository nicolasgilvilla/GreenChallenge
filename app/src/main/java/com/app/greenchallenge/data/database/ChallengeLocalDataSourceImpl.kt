...
class ChallengeLocalDataSourceImpl @Inject constructor(
    ...
    override val allChallenges: List<ModelCommon> = listOf(ModelCommon("", "", "", "")) //Obtener los retos y mapearlas al modelo de dominio

    override suspend fun isEmpty(): Boolean = true//Referencia de las peliculas == 0

    override fun findById(id: Int): ModelCommon = (ModelCommon("", "", "", ""))//Obtener por Id y mapear al domain model
